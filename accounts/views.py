...
from .forms import RegistrationForms,UserForm,UserProfileForm
    ...
    if user is not None:
      try:
        ...
        if is_cart_item_exists :
          ...
          # getting a product variations bye cart id 
          product_variation=[]
          for item in cart_item:
            variation=item.variations.all()
            product_variation.append(list(variation))

          #get the cart items for the user to access his product variation
          ...
          for item in cart_item:
            ...
            #product_variation=[1,3,4,5,6,7]
            #ex_var_list=[3,5,8,5,6]    
